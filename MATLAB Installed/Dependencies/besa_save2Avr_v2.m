function status = besa_save2Avr_v2(file_path, file_name, data_matrix, ...
    time_samples, channel_labels, data_scale_factor, time_scale_factor, segment_label)
...
fprintf(fid, ...
    'Npts= %d   TSB= %f DI= %f SB= 1.000 SC= 200.0 Nchan= %d SegmentName= %s\n', ...
    n_tbins, start_time, time_step, n_channels, segment_label);
