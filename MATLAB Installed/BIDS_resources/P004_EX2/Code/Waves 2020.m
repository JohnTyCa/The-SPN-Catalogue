...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 4/EX2 both (surviving 17)/Grand Averages'
...
%ELECTRODES
electrodes = [22 23 24 25 59 60 61 62]; % Left and right Scottetal2009
