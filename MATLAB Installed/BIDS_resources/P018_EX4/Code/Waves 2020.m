...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 18/EX4 Ref Vert and Horz/Grand Averages'
load timeVector;
load grandAverages;
...
figure('color',[1,1,1])
P = plot(timeVector, [RandRandRand, Rep, Change],'LineWidth',LineWidth);
...
figure('color',[1,1,1])
P = plot(timeVector, [DiffRep, DiffChange,Zeroline],'LineWidth',LineWidth);
axis([-200 2100 -4 1]);
