...
ERPerror.AS20SPN.amplitudes = ERPerror.AS20.amplitudes- ERPerror.Rand20.amplitudes;
ERPerror.S20SPN.amplitudes = ERPerror.S20.amplitudes- ERPerror.Rand20.amplitudes;
ERPerror.AS40SPN.amplitudes = ERPerror.AS40.amplitudes- ERPerror.Rand40.amplitudes;
ERPerror.S40SPN.amplitudes = ERPerror.S40.amplitudes- ERPerror.Rand40.amplitudes;
ERPerror.AS80SPN.amplitudes = ERPerror.AS80.amplitudes- ERPerror.Rand80.amplitudes;
ERPerror.S80SPN.amplitudes = ERPerror.S80.amplitudes- ERPerror.Rand80.amplitudes;



conditionNames={'AS20','S20','Rand20','AS40','S40','Rand40','AS80','S80','Rand80','AS20SPN','S20SPN','AS40SPN','S40SPN','AS80SPN','S80SPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
