...
myWin = visual.Window(size = [500,500], allowGUI=False, monitor = 'EEG lab participant', units = 'pix', fullscr= False, color=(0.5, 0.5, 0.5))
...
e = visual.Rect(myWin, size = [30,30], interpolate=True, fillColor= 'grey', lineColor = 'black')
...
pattern(1,reg,100,'n',0,100) #This calls the experiment
myWin.flip()
myWin.getMovieFrame()
core.wait(2)
myWin.flip()
myWin.saveMovieFrames('Grid.png') # useful  screen saver system 
core.quit()
