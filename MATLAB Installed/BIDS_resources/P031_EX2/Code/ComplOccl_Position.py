...
expName='CompletionOccluder_Position'#from the Builder filename that created this script
expInfo={'N':0,'order':1}
...
#        ma= myClock.getTime()
        ...
        #imagename= os.path.join(path, imageB)
        myImage.setImage('images/'+imageB)
        if SecondPolyPos == 'top':
            myImage.setPos([0,maxheight])
        elif SecondPolyPos == 'bottom':
            myImage.setPos([0,-maxheight])
...
#
if expInfo['order']== 1: 
    trialbook='COpos_trialbook1.xlsx'
elif expInfo['order']== 2: 
    trialbook='COpos_trialbook2.xlsx'
elif expInfo['order']== 3: 
    trialbook='COpos_trialbook3.xlsx'
elif expInfo['order']== 4: 
    trialbook='COpos_trialbook2.xlsx'
elif expInfo['order']== 5: 
    trialbook='COpos_trialbook3.xlsx'
elif expInfo['order']== 6: 
    trialbook='COpos_trialbook6.xlsx' 
elif expInfo['order']== 7: 
    trialbook='COpos_trialbook7.xlsx'
elif expInfo['order']== 8: 
    trialbook='COpos_trialbook8.xlsx'
#practrialbook = 'CO_Figures.xlsx'
practrialbook='CO_images.xlsx'
