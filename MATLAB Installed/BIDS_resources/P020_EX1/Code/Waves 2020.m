...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 20/Grand Averages';
load timeVector;
load grandAverages;
...
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'RefsBlack','RandsWhites','RefsBlack','RefsWhite','RandsWBW','RandsBWB','RefsWBW','RefsBWB'},'FontSize',14,'Location','southwest');
xlabel('Time from stimulus onset (ms)');
ylabel('Amplitude (microvolts)');
grid('on')
legend('boxoff')
