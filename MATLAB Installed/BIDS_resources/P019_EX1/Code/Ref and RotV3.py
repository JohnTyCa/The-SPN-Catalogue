...
expName='Ref and Rot'#from the Builder filename that created this script
expInfo={'participant':''}
...
def runBlock(trialbook,Reps):
    ...
    refList = pictureShuffle(420,'REF')  # this is a shuffled list of Reflection image names
    randList = pictureShuffle(1440,'Rand') # this is a shuffled list of Random image names.
    rotList = pictureShuffle(420,'ROT') # this is a shuffled list of Random image names.
