...
ERPerror.RotRotRotSPN.amplitudes = ERPerror.RotRotRot.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RefRefRotSPN.amplitudes = ERPerror.RefRefRot.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RotRotRefSPN.amplitudes = ERPerror.RotRotRef.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RandRandRefSPN.amplitudes = ERPerror.RandRandRef.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RandRandRotSPN.amplitudes = ERPerror.RandRandRot.amplitudes- ERPerror.RandRandRand.amplitudes;

conditionNames={'RandRandRand', 'RefRefRef','RotRotRot','RefRefRot','RotRotRef','RandRandRef','RandRandRot','RefRefRefSPN','RotRotRotSPN','RefRefRotSPN','RotRotRefSPN','RandRandRefSPN','RandRandRotSPN'};
