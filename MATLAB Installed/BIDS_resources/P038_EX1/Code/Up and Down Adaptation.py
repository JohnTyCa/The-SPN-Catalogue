...
fixationSize = 40
myWin = visual.Window(size = [1280,1024], allowGUI=False, monitor = 'EEGlab3d', units = 'pix', fullscr= True, color=(0.5, 0.5, 0.5))
...
i = visual.ImageStim(myWin, mask=None, units='pix', pos=(0.0, 0.0), ori=0.0, color=(1.0, 1.0, 1.0), colorSpace='rgb', contrast=1.0, opacity=1.0, depth=0, interpolate=False, flipHoriz=False, flipVert=False, texRes=128, name=None, autoLog=None, maskParams=None)
