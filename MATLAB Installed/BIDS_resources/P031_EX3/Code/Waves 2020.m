...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 31/EX3 Colour/Grand Averages';
load timeVector;
load grandAverages;
...
DiffSymmetrySameSame  = SymmetrySame  - AsymmetrySame;
DiffSymmetrySameNovel  = SymmetrySame  - AsymmetryNovel;
DiffSymmetryNovelNovel  = SymmetryNovel - AsymmetryNovel;
DiffSymmetryNovelSame  = SymmetryNovel - AsymmetrySame;
