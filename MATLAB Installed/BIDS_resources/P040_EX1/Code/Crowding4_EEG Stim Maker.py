...
def pick_coord_random():
    ...
    nsteps = int(360 /angle) # ALEXIS CHANGED. 
...
#        condition = 'RandFlankerV'   #debug
        ...
        elif condition == 'SymFlankerV':
           myTarget.vertices=v2
           drawMyTarget([250, 0])
           myTarget.vertices=v1
           drawMyTarget([250, 100])
           myTarget.vertices=v3
           drawMyTarget([250, -100])

        elif condition == 'RandFlankerV':
           myTarget.vertices=v1
           drawMyTarget([250, 0])
           myTarget.vertices=v3
           drawMyTarget([250, 100])
...
#event.waitKeys(keyList = ['g'])
runBlock('trialbook3c.xlsx',1)
message('HelloMain')
#event.waitKeys(['g'])
#runBlock('trialbook3c.xlsx',20)
#message('Goodbye')
core.wait(2)
myWin.close
core.quit()