...
ERPerror.MemorySPN.amplitudes = ERPerror.SymmetryMemory.amplitudes- ERPerror.RandomMemory.amplitudes;
ERPerror.PassiveSPN.amplitudes = ERPerror.SymmetryPassive.amplitudes- ERPerror.RandomPassive.amplitudes;




conditionNames={'SymmetryMemory','RandomMemory','SymmetryPassive','RandomPassive','MemorySPN','PassiveSPN'};
