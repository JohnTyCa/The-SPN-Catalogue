...
def message(Type, nBlocksToGo = 1):
    if Type == 'HelloPractice':
        message = ('Welcome to the Practice Experiment. You will see LOTS of patterns. Your task is to decide whether the green patterns are the same or different on each trial. Please fixate on the red cross')
    elif Type == 'HelloMain':
