...
p = 0
minDots = 4 # for 8 fold patterns with symmetry, we can often get zero dots in a segment without this hack. 
for x in range(repeats):
    dotcount = 0
    while dotcount < minDots:
        dotcount = pattern(folds,'degraded',0) #This calls the experiment
    myWin.flip()
    core.wait(duration)
    myWin.getMovieFrame()
    myWin.flip()
