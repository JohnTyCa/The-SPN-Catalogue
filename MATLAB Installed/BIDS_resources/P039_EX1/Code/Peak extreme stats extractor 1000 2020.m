...
cd(folder2)
save('PositivePeakResults1000','PositivePeakResults');
save('NegativePeakResults1000','NegativePeakResults');
clear all
load 'PositivePeakResults1000';
load 'NegativePeakResults1000';
