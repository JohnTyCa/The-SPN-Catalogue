...
for c = 1:length(conditionNames)
    ...
    for i = 1:subjects;
        ...
        p = p+1;
        k = num2str(i);
        n = ['S',k,conditionNames{c},'750AVG.mat'];
        load(n);
...
cd(folder2)
save('PositivePeakResults750','PositivePeakResults');
save('NegativePeakResults750','NegativePeakResults');
clear all
load 'PositivePeakResults750';
load 'NegativePeakResults750';
