...
for c = 1:length(conditionNames)
    ...
    for i = 1:subjects;
        ...
        p = p+1;
        k = num2str(i);
        n = ['S',k,conditionNames{c},'500AVG.mat'];
        load(n);
...
cd(folder2)
save('PositivePeakResults500','PositivePeakResults');
save('NegativePeakResults500','NegativePeakResults');
clear all
load 'PositivePeakResults500';
load 'NegativePeakResults500';
