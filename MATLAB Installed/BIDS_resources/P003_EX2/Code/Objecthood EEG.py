...
Question=visual.TextStim(myWin, pos=[0, 0], height=30, color='black')
...
trials=data.TrialHandler(nReps=1, method='random', trialList=data.importConditions('ObjectTrialbook.xlsx'))
