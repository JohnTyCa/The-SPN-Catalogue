# This is the new blobs version... Yiovi use this! 
...
expName='Left and Right Eye Tracking'#from the Builder filename that created this script
expInfo={'participant':''}
dlg=gui.DlgFromDict(dictionary=expInfo,title=expName)
if dlg.OK==False: core.quit() #user pressed cancel
expInfo['date']=data.getDateStr()#add a simple timestampaa
...
fixationSize = 40
circleSize = 5
imageSize = circleSize/0.6666666666667
print imageSize
offset = 5 

myWin = visual.Window(size = [1280,1024], allowGUI=False, monitor = 'EEGlab3d', units = 'pix', fullscr= True, color=(-1, -1, -1), screen=1)
baseline = visual.ImageStim(myWin, size = imageSize, image='baseline.png',mask=None, units='deg', pos=(0.0, 0.0), ori=0.0, color=(1.0, 1.0, 1.0), colorSpace='rgb', contrast=1.0, opacity=1.0, depth=0, interpolate=False, flipHoriz=False, flipVert=False, texRes=128, name=None, autoLog=None, maskParams=None)
i = visual.ImageStim(myWin, size = imageSize, mask=None, units='deg', pos=(0.0, 0.0), ori=0.0, color=(1.0, 1.0, 1.0), colorSpace='rgb', contrast=1.0, opacity=1.0, depth=0, interpolate=True, flipHoriz=False, flipVert=False, texRes=128, name=None, autoLog=None, maskParams=None)
