...
cd '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 14/EX3 Disc Col Control/Grand Averages';
load timeVector;
load grandAverages;
...
GFPDiffCheck = [GFPDiffPattern,GFPDiffFlower,GFPDiffLandscape];
