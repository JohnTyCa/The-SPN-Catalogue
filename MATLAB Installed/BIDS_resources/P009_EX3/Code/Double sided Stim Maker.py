...
myWin = visual.Window(allowGUI=False, size=[screenWidth,screenHeight],units='pix', fullscr= False, color = 'black')
...
def runBlock(trialbook,Reps):
    ...
    for thisTrial in trials:
        ...
        #parallel.setData(0)
        myWin.getMovieFrame()
        n= "%s%s%s%s" %(LeftPattern,RightPattern,Colour,'.png')
