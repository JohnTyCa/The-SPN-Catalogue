...
ERPerrorLeft.SPNLeft.amplitudes = ERPerrorLeft.REFREF.amplitudes- ERPerrorLeft.RANDRAND.amplitudes;
ERPerrorRight.SPNRight.amplitudes = ERPerrorRight.REFREF.amplitudes- ERPerrorLeft.RANDRAND.amplitudes;



conditionNames={'REFREF','RANDRAND','SPNLeft'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
...
conditionNames={'REFREF','RANDRAND','SPNRight'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
