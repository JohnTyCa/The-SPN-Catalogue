...
if high == 1000
    ...
    GFPDiffCheckb = [GFPDiff,GFPDiff]%copyorder
...
%headplot(DIFFREFREF, 'BioSemiSpline.spl', 'maplimits',[-zscale, zscale],'electrodes', 'off', 'view', [0 0]);
colorbar('FontSize',FontSize)
caxis([-zscale, zscale])
t =['GFP=',num2str(round(GFPDiff,3))];
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
