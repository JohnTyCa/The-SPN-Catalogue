...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 11/EX1 Shape matching task';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 11/EX1 Shape matching task/Grand Averages';
cd(folder1);
...
%CONDITIONS
conditionNames={'SymmetryFirst'};
%conditionNames={'Sym1Sym1','Rand1Rand1','Sym1Sym2','Rand1Rand2'};
%conditionNames={'SymRand','RandSymm'};
%conditionNames={'SymRand','Rand1Rand2','RandSym','Sym1Sym2'}; % This analysis excludes all 'same' trials, to balance numbers
%conditionNames={'Same','Different'};
