...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 30/EX1 Gerbino Fixed';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 30/EX1 Gerbino Fixed/Grand Averages';
cd(folder1)
...
ERPerror.ConvexSPN.amplitudes = ERPerror.RefConvex.amplitudes- ERPerror.Random.amplitudes;
ERPerror.ConcaveSPN.amplitudes = ERPerror.RefConcave.amplitudes- ERPerror.Random.amplitudes;
...
conditionNames = {'Random','RefConvex','RefConcave','ConvexSPN','ConcaveSPN'}; 
for x = 1:length(conditionNames)
        c = conditionNames{x};
