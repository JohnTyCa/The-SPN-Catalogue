...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 30/EX1 Gerbino Fixed/Grand Averages'
load timeVector;
load grandAverages;
...
DiffRefConvex  = RefConvex  - Random;
DiffRefConcave = RefConcave - Random;
...
figure('color',[1,1,1])
P = plot(timeVector, [Random,RefConvex,RefConcave],'LineWidth',LineWidth);
axis([-1000 2000 -10 10]);
set(gca,'YTick',-10:5:10);
set(gca,'XTick',-1000:500:2000,'XMinorTick','on');
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'Random','RefConvex','RefConcave'},'FontSize',FontSize,'Location','southeast');
