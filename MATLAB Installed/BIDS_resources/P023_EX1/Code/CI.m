...
ERPerror.AntiSymmBWSPN.amplitudes = ERPerror.AntiSymmBW.amplitudes- ERPerror.RandBW.amplitudes;
ERPerror.SymmBWSPN.amplitudes = ERPerror.SymmBW.amplitudes- ERPerror.RandBW.amplitudes;
ERPerror.AntiSymmColSPN.amplitudes = ERPerror.AntiSymmCol.amplitudes- ERPerror.RandCol.amplitudes;
ERPerror.SymmColSPN.amplitudes = ERPerror.SymmCol.amplitudes- ERPerror.RandCol.amplitudes;



conditionNames={'AntiSymmBW','SymmBW','RandBW','AntiSymmCol','SymmCol','RandCol','AntiSymmBWSPN','SymmBWSPN','AntiSymmColSPN','SymmColSPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
