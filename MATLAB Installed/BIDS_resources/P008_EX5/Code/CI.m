...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 8/EX5 AS4F';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 8/EX5 AS4F/Grand Averages';
cd(folder1)
subjects = 22;
%ELECTRODES
...
ERPerror.SPNAntiSymmetry.amplitudes = ERPerror.AntiSymmetry.amplitudes- ERPerror.Random.amplitudes;
ERPerror.SPNSymmetry.amplitudes = ERPerror.Symmetry.amplitudes- ERPerror.Random.amplitudes;



conditionNames = {'Random','AntiSymmetry','Symmetry','SPNAntiSymmetry','SPNSymmetry'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
