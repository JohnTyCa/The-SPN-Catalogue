...
% figure('color',[1,1,1])
% topoplot(AntiSymmetry, channelLocs,'numcontour', contourRes,'electrodes','numbers');
% colorbar('FontSize',FontSize)
% caxis([-zscale, zscale])
% title('AntiSymmetry','FontSize',FontSize);
% toponame = ['AntiSymmetry',(num2str(low)),'-',num2str(high),'.png'];
% saveas(gcf,toponame);
...
% figure('color',[1,1,1])
% topoplot(DiffSymmetry, channelLocs, 'numcontour', contourRes,'electrodes','numbers');
% figure('color',[1,1,1])
% topoplot(DiffSymmetry, 'Channels.xyz', contourRes,'electrodes','numbers');
% % figure('color',[1,1,1])
% topoplot(DiffSymmetry, channelLocs,'numcontour', contourRes,'electrodes','labels');
% figure('color',[1,1,1])
% topoplot(DiffSymmetry, 'Channels.xyz','numcontour', contourRes,'electrodes','labels');
%colorbar('FontSize',FontSize)