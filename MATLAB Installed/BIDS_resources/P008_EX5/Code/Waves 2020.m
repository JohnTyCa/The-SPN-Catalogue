...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 8/EX5 AS4F/Grand Averages'
load timeVector;
load grandAverages;
...
%YOU WANT TO SMOOTH THE ERP WAVES? . 
smoothfactor = 10;
smoothOn = 'off';
...
StyleOrder = {'-','-','-'}';
ColorArray = {'Color'};
ColorOrder = {[0 0 0],[0 0.5 0.5],[0 1 0]}';
figure('color',[1,1,1])
...
set(gca,'XTick',-200:200:1000,'XMinorTick','on');
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'AntiSymmetry','Symmetry'},'FontSize',FontSize,'Location','southwest');
