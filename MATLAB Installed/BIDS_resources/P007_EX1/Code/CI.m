...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 7/EX1 Disc Reg';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 7/EX1 Disc Reg/Grand Averages';
cd(folder1)
subjects = 24;
%ELECTRODES
...
ERPerror.SPNFlat.amplitudes = ERPerror.ReflectionFlat.amplitudes- ERPerror.RandomFlat.amplitudes;
ERPerror.SPNSlant.amplitudes = ERPerror.ReflectionSlant.amplitudes- ERPerror.RandomSlant.amplitudes;


conditionNames = {'ReflectionFlat','ReflectionSlant', 'RandomFlat','RandomSlant','SPNFlat','SPNSlant'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
