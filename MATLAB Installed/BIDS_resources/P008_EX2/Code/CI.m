...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 8/EX2 W Ref Rep and Spinning Glass';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 8/EX2 W Ref Rep and Spinning Glass/Grand Averages';
cd(folder1)
subjects = 22;
%ELECTRODES
...
ERPerror.SPNGlass.amplitudes = ERPerror.Glass.amplitudes- ERPerror.Random.amplitudes;
...
conditionNames = {'Random','Glass','Reflection','Translation','SPNGlass','SPNReflection','SPNTranslation'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
