...
myWin = visual.Window(size=(800,800), allowStencil = True, monitor='testMonitor', units='pix', color='grey')

expName='GlassExperiment_Holographic'#from the Builder filename that created this script
expInfo={'participant':'name', 'number':''}
...
#message('Goodbye')
core.wait(2)
myWin.saveMovieFrames('image.png') # useful  screen saver system 
myWin.close
core.quit()