...
ERPerror.SPNGoodValence.amplitudes = ERPerror.ReflectionGoodValence.amplitudes- ERPerror.RandomGoodValence.amplitudes;
ERPerror.SPNBadValence.amplitudes = ERPerror.ReflectionBadValence.amplitudes- ERPerror.RandomBadValence.amplitudes;
ERPerror.SPNGoodRegularity.amplitudes = ERPerror.ReflectionGoodRegularity.amplitudes- ERPerror.RandomGoodRegularity.amplitudes;
ERPerror.SPNBadRegularity.amplitudes = ERPerror.ReflectionBadRegularity.amplitudes- ERPerror.RandomBadRegularity.amplitudes;


conditionNames = {'RandomGoodValence','RandomBadValence','ReflectionGoodValence','ReflectionBadValence','RandomGoodRegularity','RandomBadRegularity','ReflectionGoodRegularity','ReflectionBadRegularity','SPNGoodValence','SPNBadValence','SPNGoodRegularity','SPNBadRegularity'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
