...
ERPerror.PredictableSPN.amplitudes = ERPerror.Predictable.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.UnpredictableSPN.amplitudes = ERPerror.Unpredictable.amplitudes- ERPerror.RandRandRand.amplitudes;




conditionNames={'RandRandRand', 'Predictable','Unpredictable','PredictableSPN','UnpredictableSPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
