...
figure('color',[1,1,1])
topoplot(Diff100, channelLocs,'numcontour', contourRes,'colormap',cmocean,'electrodes','labels');
caxis([-zscale, zscale])
%colorbar('FontSize',FontSize)
t =['GFP=',num2str(round(GFPDiff100,3))];
%title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['Ref100Labels',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);

clear


% for i = 1:length(Diff100)
%     Diff100 = Ref100 - Rand;
%     Diff100(i) = 10
% 
% 
