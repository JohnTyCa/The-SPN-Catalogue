...
StyleOrder = {'-','-','-','-','-','-'}';
ColorArray = {'Color'};
ColorOrder = {[1 0 0],[0.8 0 0.2],[0.6 0 0.4], [0.4 0 0.6],[0.2 0 0.8],[0 0 1]}';
close all
figure('color',[1,1,1])
...
legend({'Random', '20', '40','60', '80','100'},'FontSize',FontSize,'Location','southwest');
...
StyleOrder = {'-','-','-','-','-','--'}';
ColorArray = {'Color'};
ColorOrder = {[0.8 0 0.2],[0.6 0 0.4], [0.4 0 0.6],[0.2 0 0.8],[0 0 1],[1 0 0]}';
figure('color',[1,1,1]);
