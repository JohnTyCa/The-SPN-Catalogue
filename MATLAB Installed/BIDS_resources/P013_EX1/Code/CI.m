...
folder1 =  '/Volumes/SPN Catalog/Expanded Catalogue/Project 13/EX1 Reg Task';
folder2 =  '/Volumes/SPN Catalog/Expanded Catalogue/Project 13/EX1 Reg Task/Grand Averages';
cd(folder1);
subjects = 26;
%ELECTRODES
