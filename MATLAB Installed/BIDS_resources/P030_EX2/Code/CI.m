...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 30/EX2 Gerbino Black Disc Col';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 30/EX2 Gerbino Black Disc Col/Grand Averages';
cd(folder1)
...
ERPerror.ConvexSPN.amplitudes = ERPerror.RefConvex.amplitudes- ERPerror.RandomConvex.amplitudes;
ERPerror.ConcaveSPN.amplitudes = ERPerror.RefConcave.amplitudes- ERPerror.RandomConcave.amplitudes;
...
conditionNames = {'RandomConvex','RandomConcave','RefConvex','RefConcave','ConvexSPN','ConcaveSPN'}; 
for x = 1:length(conditionNames)
        c = conditionNames{x};
