...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 32/EX2 FigureGround';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 32/EX2 FigureGround/Grand Averages';
cd(folder1)
...
ERPerror.FigureSPN.amplitudes = ERPerror.FigureSym.amplitudes- ERPerror.FigureAsym.amplitudes;
ERPerror.GroundSPN.amplitudes = ERPerror.GroundSym.amplitudes- ERPerror.GroundAsym.amplitudes;




conditionNames={'FigureSym', 'GroundSym','FigureAsym','GroundAsym','FigureSPN','GroundSPN'};
