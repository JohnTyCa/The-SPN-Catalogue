...
fixation=visual.TextStim(myWin, text='+', pos=[0, 0], height=50, color='red')#this is a gray cross for the fixation
...
def drawStim(sten, stencilL, stencilR, cond): #stencilL, stencilR,
    
    # this is the preview       
        if cond == 'figure'or cond == 'ground':  # cond in ['figure', 'ground']  
            sten.enabled = False
            stencilL.enabled = False
...
def mainLoop(trialbook, reps): # define Reps and set at bottom how many blocks you want
    ...
    for thisTrial in trials:
        ...
        v = makePattern(0, 0, 'circle', nV, 100, 0)
        if symmetry == 'sym':
        ...
        verticesP = [(-30,-256),(-30,256),(30,256),(30,-256)]
...
#            pass #do nothing
        ...
        drawStim(stencilP, stencilL, stencilR, cond)
        myWin.flip()
...
# this is the stimulus
        ...
        drawStim(stencil, stencilL, stencilR, cond)
