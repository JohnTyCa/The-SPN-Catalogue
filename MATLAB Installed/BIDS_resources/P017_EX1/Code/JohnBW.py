...
myWin = visual.Window(allowGUI=False, units='pix', monitor = 'EEGLAB_3D', size=(920,620), fullscr=True,screen=2,gammaErrorPolicy = 'warn')#creates a window using pixels as units
myClock = core.Clock()
