...
myWin = visual.Window(allowGUI=False, units='pix', monitor = 'EEGLAB_3D', size=(920,620), fullscr=True,screen=0)#creates a window using pixels as units
myClock = core.Clock()

duration = 0.1 # this sets stimulus duration
...
#        trialCounter = trialCounter + 1
        ...
        t = myClock.getTime() + 0.1     # baseline
        if task =='white':
