...
ERPerrorLeft.SPNLeft.amplitudes = ERPerrorLeft.NOTHINGREF.amplitudes- ERPerrorLeft.NOTHINGRAND.amplitudes;
ERPerrorRight.SPNRight.amplitudes = ERPerrorRight.REFNOTHING.amplitudes- ERPerrorRight.RANDNOTHING.amplitudes;



conditionNames={'NOTHINGREF','NOTHINGRAND','SPNLeft'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
...
conditionNames={'REFNOTHING','RANDNOTHING','SPNRight'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
