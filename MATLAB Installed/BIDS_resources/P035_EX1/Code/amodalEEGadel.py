...
myWin = visual.Window(allowGUI=False, units='pix', allowStencil=False, size=(800,800), fullscr=True, monitor = 'EEG lab participant')#creates a window using pixels as units
...
def runBlock(filename):
    ...
    if filename=='data/practice':
        ...
        trials=data.TrialHandler(nReps=10, method='random', trialList=data.importConditions('trialbook.xlsx')) #
