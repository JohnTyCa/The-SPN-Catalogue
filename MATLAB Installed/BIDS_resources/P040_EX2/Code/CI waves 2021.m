...
%SPN 234 when left electrodes selected
figure('color',[1,1,1])
...
%SPN 235 when left electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN 236 when left electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN 237 when left electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN238 when right electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN239 when right electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN240 when right electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
%SPN241 when right electrodes selected
figure('color',[1,1,1])
StyleArray = {'LineStyle'};
StyleOrder = {'-','-'}';
ColorArray = {'Color'};
...
% SPN234 when left electrodes selected
close all
figure('color',[1,1,1])
themeCol = 'blue';
...
alpha(0.4)
%%%%%%%%%%%%% Select left hemisphere electrodes %%%%%%%%%%%%%%%
% SPN235 when left electrodes selected
figure('color',[1,1,1])
themeCol = 'blue';
rectangle('position',[low, -5,high-low,6],'FaceColor',[1 1 0 0.1],'EdgeColor','black'); 
...
% SPN236 when left electrodes selected
figure('color',[1,1,1])
themeCol = 'blue';
rectangle('position',[low, -5,high-low,6],'FaceColor',[1 1 0 0.1],'EdgeColor','black'); 
...
% SPN237 when left electrodes selected
figure('color',[1,1,1])
themeCol = 'blue';
rectangle('position',[low, -5,high-low,6],'FaceColor',[1 1 0 0.1],'EdgeColor','black'); 
