...
cd '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V7/Project 30/EX3 Gerbino Black Disc Reg/Grand Averages';
load timeVector;
load grandAverages;
load ERPerror;
%CONDITIONS
