...
from psychopy import core, data, event, visual, gui, sound #parallel
...
ITI = 2 #how long is the ITI in seconds? Two seconds gives enough time for a stable baseline to develop. 
envelopeHeight = 400 
...
screenLag = 0.5
blockDuration = 8# How many trials per block 
minDotSize = 20
maxDotSize = 80
