...
folder1 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 10/EX1 Vertical';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 10/EX1 Vertical/Grand Averages';
cd(folder1)
subjects = 28;
%ELECTRODES

electrodes = [24 25 61 62]; % These will be used if no dogma selected
d = input('which dogma?');
...
ERPerror.SPN.amplitudes = ERPerror.Reflection.amplitudes- ERPerror.Random.amplitudes;



conditionNames = {'Random','Reflection','SPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
