...
myWin = visual.Window(allowGUI=False, monitor = 'EEG lab participant', units='pix', allowStencil=True, color= myWinColor, size= (1280,1024)) #size=(1600,900)) #size=(800,600)) # , monitor = 'EEG lab participant')#creates a window using pixels as units
myClock = core.Clock()
