...
toponame = ['SPN242 (DiffTargetSymRight)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN243 (DiffSymFlankerSRight)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN244 (DiffSymFlankerRRight)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN245 (DiffRandFlankerSRight)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN246 (DiffTargetSymLeft)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN247 (DiffSymFlankerSLeft)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN248 (DiffSymFlankerRLeft)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
...
title(t,'FontSize',FontSize,'fontweight','normal');
toponame = ['SPN249 (DiffRandFlankerSLeft)',(num2str(low)),'-',num2str(high),'.png'];
saveas(gcf,toponame);
clear
