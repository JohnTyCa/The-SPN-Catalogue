...
expName='CrowdingB&W'#from the Builder filename that created this script
expInfo={'participant':''}
...
myTarget1 =visual.ShapeStim(myWin, lineWidth = 2, lineColor = 'white')
stim =visual.ShapeStim(myWin, fillColor=[-1,-1,-1], lineColor =None)
stim1 =visual.ShapeStim(myWin, fillColor=[1,1,1], lineColor =None)
...
def drawMyTarget1(position):

    v =ndarray.tolist(myTarget1.vertices)
    v.append(v[0])
    centre = visualExtra.analysecentroid(v)
    stim1.setPos(position)
    myTarget1.setPos(position)
...
#        condition = 'RandFlankerV'   #debug
        ...
        if condition == 'TargetSymBlack':
           myTarget.vertices=v2
           drawMyTarget([250, 0])

        elif condition == 'TargetRandBlack':
           myTarget.vertices =v4
           drawMyTarget([250, 0])

        elif condition == 'SymFlankerSWhite':
           myTarget1.vertices=v1
           drawMyTarget1([150, 0])
           myTarget.vertices=v2
           drawMyTarget([250, 0])
           myTarget1.vertices=v3
           drawMyTarget1([350, 0])

        elif condition == 'RandFlankerSWhite':
           myTarget1.vertices= v1
           drawMyTarget1([150, 0])
           myTarget.vertices=v4
           drawMyTarget([250, 0])
           myTarget1.vertices=v2
           drawMyTarget1([350, 0])
           
        elif condition == 'SymFlankerRWhite':
           myTarget1.vertices=v4
           drawMyTarget1([150, 0])
           myTarget.vertices=v1
           drawMyTarget([250, 0])
           myTarget1.vertices=v5
           drawMyTarget1([350, 0])

        elif condition == 'RandFlankerRWhite':
           myTarget1.vertices=v4
           drawMyTarget1([150, 0])
           myTarget.vertices=v5
           drawMyTarget([250, 0])
           myTarget1.vertices=v6
           drawMyTarget1([350, 0])
           


           
        elif condition == 'TargetSymBlackL':
           myTarget.vertices=v1
           drawMyTarget([-250, 0])

        elif condition == 'TargetRandBlackL':
           myTarget.vertices =v4
           drawMyTarget([-250, 0])

           
        elif condition == 'SymFlankerSWhiteL':
           myTarget1.vertices=v1
           drawMyTarget1([-150, 0])
           myTarget.vertices=v2
           drawMyTarget([-250, 0])
        ...
        elif condition == 'RandFlankerSWhiteL':
           myTarget1.vertices= v1
           drawMyTarget1([-150, 0])
           myTarget.vertices=v4
           drawMyTarget([-250, 0])
        ...
        elif condition == 'SymFlankerRWhiteL':
           myTarget1.vertices=v4
           drawMyTarget1([-150, 0])
           myTarget.vertices=v1
           drawMyTarget([-250, 0])
        ...
        elif condition == 'RandFlankerRWhiteL':
           myTarget1.vertices=v4
           drawMyTarget1([-150, 0])
           myTarget.vertices=v5
           drawMyTarget([-250,0])
...
#        myWin.getMovieFrame()
#        imagename = 'images/'+condition + '.png'
...
event.waitKeys(['g'])
runBlock('trialbookBlack&White.xlsx',1)
message('HelloMain')
event.waitKeys(['g'])
runBlock('trialbookBlack&White.xlsx',20)
message('Goodbye')
core.wait(2)
myWin.close
core.quit()