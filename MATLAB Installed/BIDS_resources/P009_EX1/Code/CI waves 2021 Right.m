...
cd '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 9/EX1 Original/Grand Averages'
load timeVector;
load grandAverages; 
load ERPerrorRight;
...
REFRANDIndividuals = ERPerrorRight.REFRAND.amplitudes;
RANDREFIndividuals = ERPerrorRight.RANDREF.amplitudes;
