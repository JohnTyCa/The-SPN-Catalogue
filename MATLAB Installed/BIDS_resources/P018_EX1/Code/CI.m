...
ERPerror.RefIdentSPN.amplitudes = ERPerror.RefIdent.amplitudes- ERPerror.RandIdent.amplitudes;
ERPerror.RandRandRefSPN.amplitudes = ERPerror.RandRandRef.amplitudes- ERPerror.RandRandRand.amplitudes;



conditionNames={'RandRandRand', 'RefRefRef','RandIdent','RefIdent','RandRandRef','RefRefRefSPN','RefIdentSPN','RandRandRefSPN'};
