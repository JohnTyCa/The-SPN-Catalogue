...
#repeaterTrial(1,2,3,'REF1.png','REF2.png','REF3.png')
#core.quit()
...
def runBlock(trialbook,Reps):
    ...
    refList = pictureShuffle(300,'REF')  # this is a shuffled list of Reflection image names
    randList = pictureShuffle(1020,'Rand') # this is a shuffled list of Random image names.
...
event.waitKeys(keyList = ['g'])
runBlock('trialbook ref and Ident.xlsx',1)
message('HelloMain')
event.waitKeys(keyList = ['g'])
runBlock('trialbook ref and Ident.xlsx',15)
message('Goodbye')
core.wait(2)
myWin.close
core.quit()
