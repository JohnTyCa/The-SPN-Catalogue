...
myWin = visual.Window(allowGUI=False, color=[1, 1, 1], units='pix', size=(512, 512), allowStencil=True, fullscr= False, screen = 1) #, gammaErrorPolicy = 'ignore')
...
#        binoCon = 'contrast'
        ...
        symmetry = 'asym'  # debugging
        print (binoCon, cond, symmetry)
...
#            myWin.flip()
#            myWin.getMovieFrame()
#            myWin.saveMovieFrames("images/"+ "fixation.png")  #myWin.saveMovieFrames("images/"+ "fixation1.png", "fixation1.pdf")
            w = myClock.getTime() + 1.5
            while myClock.getTime() < w:
                if event.getKeys(["escape"]):
                    core.quit()
...
#        t = myClock.getTime() + 1.5
        myWin.getMovieFrame()
        myWin.saveMovieFrames("images/"+cond+symmetry+"vertices.png") #         myWin.saveMovieFrames("images/"+cond+symmetry+"Vertices.png", "v.pdf")
        ...
        myWin.getMovieFrame()
        myWin.saveMovieFrames("images/"+"linesonly"+symmetry+"vertices.png") #         myWin.saveMovieFrames("images/"+cond+symmetry+"Vertices.png", "v.pdf")
...
#event.waitKeys(keyList = ['g'])
#mainLoop('bookBinoConBothNew.xlsx', 2, "practice") #32 practice trials
#message('HelloMain')
#event.waitKeys(keyList = ['g'])
mainLoop('bookBinoConBothNew.xlsx', 30, "exp") #30 x 24 = 720 trials
#message('Goodbye')
#core.wait(2)
#ser.close()
myWin.close()
