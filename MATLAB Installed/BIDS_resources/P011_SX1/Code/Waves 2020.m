...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 11/Sup Ex1/Grand Averages'
load timeVector;
load grandAverages;
...
StyleOrder = {'-','-','-','-','-','-'}';
ColorArray = {'Color'};
ColorOrder = {[0 0 1],[0 1 0],[1 0 0],[0 0 0.5],[0 0.5 0],[0.5 0 0]}';
close all
figure('color',[1,1,1])
P = plot(timeVector, [SymmetryShort,SymmetryMedium,SymmetryLong,RandomShort,RandomMedium,RandomLong],'LineWidth',LineWidth);
axis([-1000 2000 -10 10]);
set(gca,'YTick',-10:5:10);
set(gca,'XTick',-1000:500:2000,'XMinorTick','on');
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder);
legend({'SymmetryShort','SymmetryMedium','SymmetryLong','RandomShort','RandomMedium','RandomLong'},'FontSize',FontSize,'Location','southeast');
...
figure('color',[1,1,1])
P = plot(timeVector, [DiffSymmetryShort,DiffSymmetryMedium,DiffSymmetryLong,Zeroline],'LineWidth',LineWidth);
axis([-200 2000 -4 1]);
set(gca,'YTick',-4:1:1,'YTickLabel',[]);
set(gca,'XTick',-200:200:1000,'XMinorTick','on','XTickLabel',[]);
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'Short','Medium','Long'},'FontSize',FontSize,'Location','southeast');
