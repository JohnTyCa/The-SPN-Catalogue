...
ERPerror.ShortSPN.amplitudes = ERPerror.SymmetryShort.amplitudes- ERPerror.RandomShort.amplitudes;
ERPerror.MediumSPN.amplitudes = ERPerror.SymmetryMedium.amplitudes- ERPerror.RandomMedium.amplitudes;
ERPerror.LongSPN.amplitudes = ERPerror.SymmetryLong.amplitudes- ERPerror.RandomLong.amplitudes;

conditionNames={'SymmetryShort','RandomShort','SymmetryMedium','RandomMedium','SymmetryLong','RandomLong','ShortSPN','MediumSPN','LongSPN'};
