...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 2/EX1 Oddball/Grand Averages'
load timeVector;
load grandAverages;
...
legend({'Random','Reflection','Rotation','Translation'},'FontSize',FontSize,'Location','southwest');
