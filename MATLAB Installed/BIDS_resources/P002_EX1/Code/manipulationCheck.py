...
# check how it flips onto break screen and beeps
...
#duration = 2.8 # how many seconds do you want each shape to be presented?
...
trials=data.TrialHandler(nReps=1, method='random', trialList=data.importTrialList('manipulationCheck_Trialbook.xlsx'))
