...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 29/Grand Averages'
load timeVector;
load grandAverages;
...
DiffSymmetryFigure = SymmetryFigure - RandomFigure;
DiffSymmetryGround = SymmetryGround - RandomGround;
...
% WidthArray = {'Linewidth'};
% WidthOrder = {1 1 1 1 5 5 1}';
figure('color',[1,1,1])
P = plot(timeVector, [RandomFigure,SymmetryFigure,RandomGround,SymmetryGround],'LineWidth',LineWidth);
axis([-1000 2000 -10 10]);
set(gca,'YTick',-10:5:10);
set(gca,'XTick',-1000:500:1000,'XMinorTick','on');
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'RandomFigure','SymmetryFigure','RandomGround','SymmetryGround'},'FontSize',FontSize,'Location','southeast');
...
figure('color',[1,1,1])
P = plot(timeVector, [DiffSymmetryFigure,DiffSymmetryGround,Zeroline],'LineWidth',LineWidth);
axis([-200 1000 -4 1]);
