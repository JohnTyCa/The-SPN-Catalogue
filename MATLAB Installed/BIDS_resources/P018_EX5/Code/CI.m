...
load timeVector;
conditionNames={'RandRandRand', 'RefRefRef','RefRotRef','RotRotRot','RotRefRot'};
for i = 1:subjects
...
ERPerror.RefRotRefSPN.amplitudes = ERPerror.RefRotRef.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RotRotRotSPN.amplitudes = ERPerror.RotRotRot.amplitudes- ERPerror.RandRandRand.amplitudes;
ERPerror.RotRefRotSPN.amplitudes = ERPerror.RefRotRef.amplitudes- ERPerror.RandRandRand.amplitudes;



conditionNames={'RandRandRand', 'RefRefRef','RefRotRef','RotRotRot','RotRefRot','RefRefRefSPN','RefRotRefSPN','RotRotRotSPN','RotRefRotSPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
