...
screenLag = 0.5
blockDuration = 10 # How many trials per blockDuration
#store info about the experiment
expName='Practice All patterns unmatched explict'#from the Builder filename that created this script
...
ResponseScreen=visual.TextStim(myWin, ori=0, text='x', pos=[0, 0], height=20, color='Black', colorSpace='rgb', units= 'pix')
...
restScreen=visual.TextStim(myWin, ori=0, text='break  wait for experiment to check electrodes', pos=[0, 0], height=60, color='Black', colorSpace='rgb', units= 'pix')

#set up handler to look after randomisation of trials etc
trials=data.TrialHandler(nReps=1, method='random', trialList=data.importConditions('PracticeEEGTrialbook.xlsx'))
