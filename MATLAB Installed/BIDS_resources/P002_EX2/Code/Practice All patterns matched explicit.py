...
expName='Practice All patterns matched explicit'#from the Builder filename that created this script
...
trials=data.TrialHandler(nReps=1, method='random', trialList=data.importConditions('PracticeEEGTrialbook.xlsx')) # sequential with randomized trialbook is necessary for EGI because it can't label triggers properly!
