...
expName='All patterns unmatched explict'#from the Builder filename that created this script
...
trials=data.TrialHandler(nReps=1, method='random', trialList=data.importConditions('EEGTrialbook.xlsx'))
