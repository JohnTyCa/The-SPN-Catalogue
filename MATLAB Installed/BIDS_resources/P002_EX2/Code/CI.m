...
folder1 =  '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 2/EX2 Regularity';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 2/EX2 Regularity/Grand Averages';
cd(folder1)
subjects = 24;
%ELECTRODES
...
load timeVector;
conditionNames={'Reflection','Translation','Rotation','Random'};
...
ERPerror.SPNRotation.amplitudes = ERPerror.Rotation.amplitudes- ERPerror.Random.amplitudes;
ERPerror.SPNTranslation.amplitudes = ERPerror.Translation.amplitudes- ERPerror.Random.amplitudes;



conditionNames={'Reflection','Translation','Rotation','Random','SPNReflection','SPNRotation','SPNTranslation'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
