...
%CONDITIONS
conditionNames={'SymSym'};
%conditionNames={'SymSym', 'RandRand','SymSymCorrect','RandRandCorrect','SymSymIncorrect','RandRandIncorrect'};
%conditionsNames={'RandRandCorrect','SymSymCorrect'}
