...
filename= 'dataShape/%s_%s' %(expInfo['participant'], expInfo['date'])

if not os.path.isdir('dataShape'):
    os.makedirs('dataShape')#if this fails (e.g. permissions) we will get error  
...
#        print seed2
       ...
       # parallel.setData(0)
        ...
        responseKey, respRT, respCorr =responseCollect(correctKey) 
        total = total+respCorr
