...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 11/Sup Ex2/Grand Averages';
load timeVector;
load grandAverages;
...
close all
figure('color',[1,1,1])
P = plot(timeVector, [SymSym, RandRand],'LineWidth',LineWidth);
axis([-1000 2000 -10 10]);
set(gca,'YTick',-10:5:10);
set(gca,'XTick',-1000:500:2000,'XMinorTick','on');
set(P,StyleArray,StyleOrder,ColorArray,ColorOrder)
legend({'Symmetry','Random'},'FontSize',FontSize,'Location','southeast');
