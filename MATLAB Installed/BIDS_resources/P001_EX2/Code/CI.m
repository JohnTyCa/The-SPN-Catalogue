...
folder1 =  '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 1/EX2 Yes No';
folder2 = '/Users/alexismakin/Desktop/Alexis Work/Symmetry EEG/SPN effect size and power/Project Folders V8/Project 1/EX2 Yes No/Grand Averages';
subjects = 24;
%ELECTRODES
...
ERPerror.SPN.amplitudes = ERPerror.Regular.amplitudes- ERPerror.Random.amplitudes;


conditionNames={'Regular','Random','SPN'};
for x = 1:length(conditionNames)
        c = conditionNames{x};
...
cd '/Volumes/SPN Catalog/Expanded Catalogue/Project 1/EX2 Yes No/Grand Averages';
