    ...
    methods (Access = private)
        ...
        function startupFcn(app, varargin)
            ...
            try
                ...
                if isdeployed
                    app.Dependencies_Folder = '';
                else
                    app.Dependencies_Folder = 'D:\SPNCAT_DEPENDENCIES\';
                end
                
                [app.PROJECT,app.EXP,app.CAT,app.APPENDIX,app.VALIDATE] = CreateSimplifiedCatalogue(app.Dependencies_Folder);
                ...
                LoadedData = load([app.Dependencies_Folder 'BioSemi-64.mat']);
                app.E = LoadedData.E;
